...
export const quickStart = (): {
  ...
  const config: GraphConfigInterface = {
    ...
    onPointClick: (pointIndex, pointPosition) => {
      console.log(
        "Clicked point index: ",
        pointIndex,
        " at position: ",
    ...
    onPointContextMenu: (pointIndex, pointPosition) => {
      console.log(
        "Context menu triggered on point index: ",
        pointIndex,
        " at position: ",
        pointPosition,
      );
    ...
    onLinkClick: (linkIndex) => {
      console.log("Clicked link index: ", linkIndex);
    },
    onLinkContextMenu: (linkIndex) => {
      console.log("Context menu triggered on link index: ", linkIndex);
    },
    onBackgroundClick: () => {
      console.log("Clicked background");
    },
    onBackgroundContextMenu: () => {
      console.log("Context menu triggered on background");
    },
    attribution:
  ...
  const links = new Float32Array([
    0,
    1, // Link from point 0 to point 1
    1,
    2, // Link from point 1 to point 2
    2,
    0, // Link from point 2 to point 0
  ]);
